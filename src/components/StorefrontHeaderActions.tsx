...
export function StorefrontHeaderActions(){
 const[items,setItems]=useState<CartItem[]>([]);const[panel,setPanel]=useState<'search'|'cart'|null>(null);const[query,setQuery]=useState('');
 ...
 return <>
  <div className="actions">
   ...
   <Link href="/account" aria-label="My Account" className="header-icon"><UserIcon/></Link>
