...
export function StorefrontHeaderActions(){
 ...
 return <>
  <div className="actions">
   ...
   <button type="button" className="header-icon" aria-label="Account" onClick={()=>setPanel('account')}><UserIcon/></button>
