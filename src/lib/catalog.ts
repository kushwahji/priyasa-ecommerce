...
export const products: Product[] = [
  ...
  { id:'silk-2', name:'Festive Silk Saree', slug:'festive-silk-saree', category:'Ethnic Wear', price:2999, mrp:3999, badge:'25% OFF', image:'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=900&q=85', colors:['Maroon','Pink'], sizes:['Free Size'], description:'A rich festive saree with a refined drape and timeless Indian styling.' },
