...
export default function RootLayout({ children }: Readonly<{children: React.ReactNode}>) {
  return <html lang="en"><body>
    ...
    <header className="site-header">
      ...
      <div className="actions"><Link href="/search" aria-label="Search" className="header-icon">⌕</Link><AuthButton/><Link href="/wishlist" aria-label="Wishlist" className="header-icon">♡</Link><Link href="/cart" aria-label="Cart" className="header-icon">▢</Link></div>
    </header>
    <main>{children}</main>
    <footer className="footer"><div className="footer-brand-block"><BrandLogo href="/"/><p>Fashion made for confidence, comfort and every celebration.</p><div className="footer-socials"><span>Instagram</span><span>Facebook</span><span>WhatsApp</span></div></div><div><h4>Shop</h4><Link href="/shop">All Products</Link><Link href="/new-arrivals">New In</Link><Link href="/category/lingerie">Lingerie</Link><Link href="/category/nightwear">Nightwear</Link><Link href="/category/ethnic-wear">Ethnic Wear</Link></div><div><h4>Help</h4><Link href="/track-order">Track Order</Link><Link href="/shipping-policy">Shipping</Link><Link href="/return-refund-policy">Returns</Link><Link href="/contact">Contact Us</Link><Link href="/faq">FAQ</Link></div><div><h4>About Priyasa</h4><Link href="/about">Our Story</Link><Link href="/size-guide">Size Guide</Link><Link href="/collections">Collections</Link><Link href="/account">My Account</Link></div></footer>
