...
const categoryLabels = ['Women', 'Kids', 'Ethnic Wear', 'Western Wear', 'Dresses', 'Bottoms'];
const categoryHrefs = ['/category/women', '/category/kids', '/category/ethnic-wear', '/category/loungewear', '/category/women', '/shop'];
...
export default function Home() {
  return <>
    <section className="hero hero-editorial">
      ...
      <div className="hero-offer-bubble"><strong>FLAT</strong><b>50%</b><span>OFF</span></div>
    </section>

    <section className="trust-strip">
      <span><TruckIcon /> <b>Free Shipping</b><small>On Orders Above ₹999</small></span><i />
      <span><GiftIcon /> <b>COD Available</b><small>Cash on Delivery</small></span><i />
      <span><ReturnIcon /> <b>Easy Returns</b><small>Hassle Free Returns</small></span><i />
      <span><ShieldIcon /> <b>Secure Payment</b><small>100% Secure</small></span>
    </section>

    <section className="section section-tight home-best-sellers">
    ...
    <section className="section section-tight"><div className="section-head"><div><span className="eyebrow dark">EVERYDAY LUXURY</span><h2>Style for Every You</h2></div></div><div className="feature-grid feature-grid-editorial"><Link href="/category/women" className="feature feature-one"><span className="eyebrow">WOMEN</span><h3>Confidence<br />starts within.</h3><span>Shop Now →</span></Link><Link href="/category/nightwear" className="feature feature-two"><span className="eyebrow">COMFORT</span><h3>Your softest<br />side.</h3><span>Shop Nightwear →</span></Link><Link href="/offers" className="feature feature-three"><span className="eyebrow">SALE</span><h3>Good style.<br />Better value.</h3><span>Shop Offers →</span></Link></div></section>

    <section className="newsletter"><div><span className="eyebrow dark">STAY IN THE LOOP</span><h2>Get first access to new styles.</h2><p>Sign in for order updates, launches and exclusive Priyasa offers.</p></div><Link className="button dark-button" href="/account">Join Priyasa →</Link></section>
  </>;
}
